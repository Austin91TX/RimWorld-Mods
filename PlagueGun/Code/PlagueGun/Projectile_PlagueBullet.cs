        ...
        protected override void Impact(Thing hitThing)
        {
            ...
            if (Def != null && hitThing != null && hitThing is Pawn hitPawn) //Fancy way to declare a variable inside an if statement. - Thanks Erdelf.
            {
                ...
                if (rand <= Def.AddHediffChance) // If the percentage falls under the chance, success!
                {
                    ...
                    string translatedMessage = TranslatorFormattedStringExtensions.Translate("Togie_PlagueBullet_SuccessMessage", launcher.Label, hitPawn.Label, Def.HediffToAdd.label);
                ...
                else //failure!
                {
                    ...
                    string translatedMessage = TranslatorFormattedStringExtensions.Translate("Togie_PlagueBullet_FalureMote", Def.AddHediffChance.ToString("P"));
